    ...
    def run(self, args):
        ...
        if args.csv:
            ...
            csv_file = csv.DictWriter(
                str_io, fieldnames=("index", "object_id", "title")
            )
...
class ObjectAddTool(ToolBase, ProjectUtilsMixin):
    ...
    def run(self, args):
        ...
        if args.regen_ids:
            ...
            insert_data = [
                object_data | {"id": gen_id()} for object_data in insert_data
            ]
...
TOOLS = (ObjectListTool, ObjectCopyTool, ObjectCutTool, ObjectMoveTool, ObjectAddTool)
