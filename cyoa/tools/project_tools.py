...
class ProjectCheckTool(ToolBase, ProjectUtilsMixin):
    ...
    def run(self, args):
        ...
        # Run all checks
        ignored_rows = {
            "ckrc", "0v3n", "otza", "dlut", "umg9", "lip0", "4dzp", "dn8o",
            "h4ce", "kgqo", "g51j", "hd9l", "0v52", "ObjectOP", "nsof", "v62t",
        }
        ...
        if result.requirement_issues:
            for issue in result.requirement_issues:
                issue_label = "Missing inputs" if issue.issue_type == "missing_inputs" else "Missing outputs"
                console.print(
