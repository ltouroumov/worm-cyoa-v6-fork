...
class FixImageLinks(PatchBase):
    def _patch_image(self, data):
        ...
        if img_is_url is False and img_data and img_data.startswith("http"):
            data["image"] = None
            del data["imageLink"]
        elif img_is_url is True and img_data and img_data.startswith("data"):
            data["image"] = None
            del data["imageLink"]
        elif img_is_url is True and img_data and img_data.startswith("http"):
